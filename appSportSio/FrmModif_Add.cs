...
{
    public partial class FrmModif_Add : Form
    {
        ...
        private void errorClear()
        {
            ...
            errorPren.Visible = false;
            errorDateNaiss.Visible = false;
            errorRue.Visible = false;
            errorCp.Visible = false;
            errorVille.Visible = false;
            errorNv.Visible = false;
            errorSport.Visible = false;
        }
        private bool setError()
        {
            ...
            if (txtPren.Text == "")
            {
                errorPren.Visible = true;
                isError = true;
            }
            if (dateTNaiss.Text == "")
            {
                errorDateNaiss.Visible = true;
                isError = true;
            }
            if (txtAdress.Text == "")
            {
                errorRue.Visible = true;
                isError = true;
            }
            if (txtCp.Text == "" || int.TryParse(txtCp.Text, out int Cp) == false)
            {
            ...
            if (txtVille.Text == "")
            {
                errorVille.Visible = true;
                isError = true;
            }
            if (txtNiv.Text == "" || int.TryParse(txtNiv.Text, out int Niv) == false)
            {
                errorNv.Visible = true;
                isError = true;
            }
            if (txtNomSport.Text == "")
            {
                errorSport.Visible = true;
                isError = true;
            }
            return isError;
        }
        ...
        public FrmModif_Add(Sportif unSportif)
        {
            InitializeComponent();
            mode = 1;
        ...
        private void errorPren_Click(object sender, EventArgs e)
        {
